...
export default function NotFound() {
  return (
    <section className="relative flex min-h-dvh items-center overflow-hidden bg-ink-900 pt-20 text-white">
      ...
      <div className="absolute left-1/2 top-1/2 h-[30rem] w-[30rem] -translate-x-1/2 -translate-y-1/2 rounded-full bg-brand-500/20 blur-[120px]" />
      <Container className="relative text-center">
        <LogoMark className="mx-auto h-14 w-auto" />
        <p className="mt-8 font-display text-7xl font-semibold tracking-tight text-white/20">404</p>
