...
export const BATTERIES: BatteryModel[] = [
  ...
  {
    id: "24-200",
    name: "Bláorku 25,6 V 200 Ah",
    volts: 25.6,
    ah: 200,
    chemistry: "lifepo4",
    note: "Millistærð fyrir báta og minni kerfi",
  },
  {
    id: "12-300",
    name: "Bláorku 12,8 V 300 Ah",
    volts: 12.8,
    ah: 300,
    chemistry: "lifepo4",
    note: "Húsbílar, hjólhýsi og ferðakerfi",
  },
  {
    id: "12-100",
